...
<head>
    ...
    <link rel="stylesheet" href="{{url('template').'/vendor/owl-carousel/css/owl.carousel.min.css'}}">
    <link rel="stylesheet" href="{{url('template').'/vendor/owl-carousel/css/owl.theme.default.min.css'}}">
    <link href="{{url('template').'/vendor/jqvmap/css/jqvmap.min.css'}}" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <!--**********************************
            Nav header start
        ***********************************-->
        @include('layouts.materials.navHeader')
        <!--**********************************
            Nav header end
        ***********************************-->
        ...
        <!--**********************************
            Header start
        ***********************************-->
        @include('layouts.materials.header')
        <!--**********************************
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        @include('layouts.materials.sidebar')
        <!--**********************************
            Sidebar end
        ***********************************-->
        ...
        ***********************************-->
        ...
        <!--**********************************
            Footer start
        ***********************************-->
        @include('layouts.materials.footer')
        <!--**********************************
            Footer end
        ***********************************-->
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{url('template').'/vendor/global/global.min.js'}}"></script>
    <script src="{{url('template').'/js/quixnav-init.js'}}"></script>
    <script src="{{url('template').'/js/custom.min.js'}}"></script>


    <!-- Vectormap -->
    <script src="{{url('template').'/vendor/raphael/raphael.min.js'}}"></script>
    <script src="{{url('template').'/vendor/morris/morris.min.js'}}"></script>


    <script src="{{url('template').'/vendor/circle-progress/circle-progress.min.js'}}"></script>
    <script src="{{url('template').'/vendor/chart.js/Chart.bundle.min.js'}}"></script>

    <script src="{{url('template').'/vendor/gaugeJS/dist/gauge.min.js'}}"></script>

    <!--  flot-chart js -->
    <script src="{{url('template').'/vendor/flot/jquery.flot.js'}}"></script>
    <script src="{{url('template').'/vendor/flot/jquery.flot.resize.js'}}"></script>

    <!-- Owl Carousel -->
    <script src="{{url('template').'/vendor/owl-carousel/js/owl.carousel.min.js'}}"></script>

    <!-- Counter Up -->
    <script src="{{url('template').'/vendor/jqvmap/js/jquery.vmap.min.js'}}"></script>
    <script src="{{url('template').'/vendor/jqvmap/js/jquery.vmap.usa.js'}}"></script>
    <script src="{{url('template').'/vendor/jquery.counterup/jquery.counterup.min.js'}}"></script>
